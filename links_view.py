...
LINK_SURFACES: dict[str, str] = {
    ...
    "lk_contracts": "Transfer Merkezi · sözleşmelerim",
    "lk_free_agents": "Transfer Merkezi · serbest oyuncular",
    "lk_pre_contract": "Transfer Merkezi · ön sözleşme adayları",
    "tc_row_": "Transfer Merkezi · dosya kartları (Oyuncu)",
    "tc_in_": "Transfer Merkezi · gelen teklif kartları (Oyuncu)",
    "tc_c_row_": "Transfer Merkezi · süren sözleşme görüşmeleri (Oyuncu)",
    "tc_c_file": "Transfer Merkezi · sözleşme dosyası (Oyuncu)",
    "tc_c_pool": "Transfer Merkezi · serbest oyuncu / ön sözleşme paneli (Oyuncu)",
